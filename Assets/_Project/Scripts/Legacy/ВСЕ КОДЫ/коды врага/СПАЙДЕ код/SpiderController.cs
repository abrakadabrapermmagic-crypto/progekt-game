...
{
    // Перечисление для отслеживания состояния паука
    ...
    private void Awake()
    {
        ...
        // Автоматический поиск триггера урона, если он не назначен вручную
    ...
    private void Update()
    {
        ...
        // Если цели нет или она мертва — переходим в Idle
    ...
    private void StartAttack()
    {
        ...
        // Запуск анимации через триггер "Attack"
    ...
    // --- МЕТОДЫ ДЛЯ ANIMATION EVENTS (Должны быть расставлены в клипе анимации) ---

    // 1. Вызывается в момент активной фазы удара
    ...
    // 2. Вызывается для отключения нанесения урона
    ...
    // 3. ОБЯЗАТЕЛЬНО: Вызывается в конце анимации, чтобы разблокировать движение
    ...
    private void UpdateAnimator()
    {
        ...
        // Расчет скорости для параметра "Speed" в Animator
